...
FLAGS = -lreadline
PARSER =   get_cmds.c cmds_trim_2.c cmds_trim.c join_cmds.c token_list_functions.c init_tokens.c cmds_parse.c heredoc.c utiles.c
HANDLE_ERR = check_err.c error.c
SOURCES = src/minishell.c
SOURCES += $(addprefix $(SRC_DIR_P)/, $(PARSER))
SOURCES += $(addprefix $(SRC_DIR_E)/, $(HANDLE_ERR))
OBJECTS = $(SOURCES:.c=.o)
NAME = minishell
